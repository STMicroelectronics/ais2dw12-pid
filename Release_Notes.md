---
pagetitle: Release Notes for AIS2DW12 Component
lang: en
...
<center>
# Release Notes for AIS2DW12 Component Driver
...
This directory contains the AIS2DW12 component drivers.
:::
...
- Change switch cases to raw uint8_t values
...
<label for="collapse-section4" aria-hidden="true">V2.0.1 / 19-Jun-2023</label>
<div>
...
<label for="collapse-section3" aria-hidden="true">V2.0.0 / 19-Mar-2023</label>
<div>
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on AIS2DW12,
visit:
[AIS2DW12](https://www.st.com/content/st_com/en/products/mems-and-sensors/automotive-sensors/ais2dw12.html)
:::
::: {.column width="5%"}
